...
- [x] **Phase 12: Replace sofia-sip with pjsip** - Replace sofia-sip FFI with pjproject for carrier SIP proxy, gaining Session Timers, PRACK, NAPTR, UPDATE, Replaces (completed 2026-04-02)
...
- [ ] 02-03-PLAN.md — Engagement tracking, Bearer token API auth middleware
...
- [ ] 05-03-PLAN.md — REST API handlers (19 endpoints) for routing tables, translation classes, manipulation classes
- [ ] 05-04-PLAN.md — Integration tests covering all 5 success criteria
...
- [ ] 09-03-PLAN.md — CDR query API (5 endpoints: list, detail, delete, recording, sip-flow)
...
| 12. Replace sofia-sip with pjsip | 5/5 | Complete   | 2026-04-02 |
